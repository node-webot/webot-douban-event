...
var provinces = /河北省?|山西省?|辽宁省?|吉林省?|黑龙江省?|江苏省?|浙江省?|安徽省?|福建省?|江西省?|山东省?|河南省?|湖北省?|湖南省?|广东省?|海南省?|四川省?|贵州省?|云南省?|陕西省?|甘肃省?|青海省?|台湾省?|内蒙古|宁夏|新疆|西藏/;
...
function listParam(text) {
  ...
  if (msg.indexOf('搜索') === 0) {
    ...
    if (msg) {
      ...
      for (var j in types) {
        var t = testContain(msg, types[j].reg);
        if (t) {
          ret['type'] = j;
          msg = cleanMsg(msg, t);
          break;
